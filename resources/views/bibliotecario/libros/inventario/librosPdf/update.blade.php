...
@section('titulo', 'UDM - Modificar Libro Digital')
...
@section('main')
    ...
    <div class="container-form">
        <form action="{{ route('bibliotecario/libros/inventario/digitales.update',['id' => $bookSelected -> lib_id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PATCH')

        <div class="form-title">
            <h2>Editar Libro Digital (PDF)</h2>
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" value="" name="lib_archivo" accept="application/pdf">
                            <p>{{$bookSelected -> lib_archivo}}</p>
                            <!-- <img src="{{ asset('storage').'/'.$bookSelected -> lib_foto }}" alt=""> -->
