            ...
            <div class="table-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="dropdown" style="width: 50%;">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{ route('/bibliotecario/libros/inventario.create') }}">Físico</a>
                                <a class="dropdown-item" href="{{ route('bibliotecario/libros/inventario/digitales/create') }}">Digital (PDF)</a>
                            </div>
                        </div>
                    </div>
                </div> 
                ...
                <div class="containerButtonsIndex">
                    <div style="display: flex;">
                        <form action="{{ route('/bibliotecario/libros/inventario.index') }}" class="input-search">
                    ...
                    <div>
                        <a href=" {{ route('/bibliotecario/libros/inventario/pdf/filtro.index') }} " class="icon-pdf" title="Reporte PDF">
                        ...
                        <tr>
                            ...
                            <td>
                                @if(!empty($libro -> lib_archivo))
                                    ...
                                    <a href="{{ url('/bibliotecario/libros/inventario/digitales/update/'.$libro->lib_id) }}" class="edit">
                                ...
                                @else
                                    ...
                                    <a href="{{ url('bibliotecario/libros/inventario/update/'.$libro->lib_id) }}" class="edit">
                                        <i class="fa-solid fa-pen-to-square"  data-toggle="tooltip" title="Editar"></i>
                                    </a>
...
@foreach ($libros as $libro)
    <div id="delete-{{$libro -> lib_id}}" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ url('/bibliotecario/libros/inventario/delete/'.$libro -> id) }}" method = "post">
                    @csrf
                    {{ method_field ('DELETE') }}
                    <div class="modal-header">						
...
@foreach ($libros as $libro)
    <div id="deletepdf-{{$libro -> lib_id}}" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ url('/bibliotecario/libros/inventario/digitales/destroy/'.$libro -> id) }}" method = "post">
                    @csrf
                    {{ method_field ('DELETE') }}
                    <div class="modal-header">						
