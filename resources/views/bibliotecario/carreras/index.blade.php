...
@endsection
    ...
    <div id="edit-{{$carreraNivel -> car_id}}" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ url('bibliotecario/carreras/modificar') }}" method="post">
                @csrf
                @method('PATCH')
    ...
    <div id="delete-{{$carreraNivel -> car_id}}" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content"> 
                <form action="{{ url('bibliotecario/carreras/eliminar/'.$carreraNivel -> car_id) }}" method = "post">
                    @csrf
                    {{ method_field ('DELETE') }}
                    <div class="modal-header">						
    ...
    <div id="add" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
            <form action="{{ route('bibliotecario/carreras.store') }}" method="POST">
                @csrf
                    <div class="modal-header">						
