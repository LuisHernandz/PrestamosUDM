...
@section('titulo', 'UDM - Editar PDF - Encabezado')
...
{{-- 
                                ...
                                <th class="element-pdf element-image">
                                    <img src="{{url('/assets/images/udm-cuerpo.png')}}"/>     
                                </th>

                                <th class="element-pdf element-text">
                                    <p>Periférico Oriente Sur No. 15-A, Barrio Nuevo, Ocosingo Chiapas, México. C.P. 29950.</p>    
                                    <p>Tel.  919 67 3 17 62, Correo Electrónico: udmplantelocosingo@gmail.com</p>    
                                </th> --}}
                            </tr>
                        </thead>
                    </table>
                ...
                {{-- <div class="clearfix">
                    ...
                    <ul class="pagination">
                        ...
                        @if ($paginas->onFirstPage())
                            <li class="page-item disabled"><a class="page-link page-next" href="#">Anterior</a></li>
                        @else
                            <li class="page-item"><a class="page-link page-next" href="{{ $paginas->previousPageUrl() }}">Anterior</a></li>
                        @endif
                        ...
                        @if ($paginas->hasMorePages())
                            <li class="page-item"><a href="{{ $paginas->nextPageUrl() }}" class="page-link page-next">Siguiente</a></li>
                        @else
                            <li class="page-item disabled"><a href="{{ $paginas->nextPageUrl() }}" class="page-link page-next">Siguiente</a></li>
                        @endif
                    </ul>
                </div> --}}
            </div>
...
@endsection
    ...
    @endforeach--}}
     ...
     @foreach ($elementosPDF as $elementoPDF )
        <div id="deleteElemento-{{$elementoPDF -> id}}" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ url('bibliotecario/edicion-pdf/encabezado/eliminar/'.$elementoPDF -> id) }}" method = "post">
                        @csrf
                        {{ method_field ('DELETE') }}
                        <div class="modal-header">						
    ...
    <div id="add" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
            <form action="{{ route('bibliotecario/edicion-pdf/encabezado.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    <div class="modal-header">						
