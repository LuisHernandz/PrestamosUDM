...
<body>
    ...
    <header>
        {{-- <img src="{{ public_path('storage/uploads/principalPDF.png') }}" style="width: 300px; height: 100px; margin:0 auto;"> --}}
    ...
    <main>
        ...
        <h2 style="color: #44546A; margin: 0; font-size: 1.2rem; text-decoration: underline;">
            ...
            @else
                <span style="display: block;">Libro de nivel: {{ $nombreNivel -> niv_nombre}}</span>
            @endif
        ...
        <img src="{{ public_path('storage/uploads/bibliotecaPDF.png') }}" style="width: 400px; height: 400px; margin:0 auto;">
    ...
    <footer style="font-size: 0.8rem">
        {{-- <p style="text-align: center;">
            Periférico Oriente Sur No. 15-A, Barrio Nuevo, Ocosingo Chiapas, México. C.P. 29950.
        </p>

        <p style="text-align: center;">
            Tel.  919 67 3 17 62, Correo Electrónico: udmplantelocosingo@gmail.com
        </p> --}}
