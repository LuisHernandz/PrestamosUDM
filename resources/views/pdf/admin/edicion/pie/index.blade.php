...
@section('titulo', 'UDM - PDF (Pie De Página)')
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {{-- <a href="#edit-{{$elementoPDF -> id}}" class="edit" data-toggle="modal">
...
@endsection
    ...
    <!-- Edit Modal HTML -->
    {{-- @foreach ($elementosPDF as $elementoPDF )
        <div id="edit-{{$elementoPDF -> id}}" class="modal fade">
                ...
                <div class="modal-content">
                    ...
                    @method('PATCH')
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                <label>Imagen</label>
                                <input type="file" class="form-control" name = "contenidoImagen" id="file-input">
    ...
    @endforeach --}}
     ...
     @foreach ($elementosPDF as $elementoPDF )
        <div id="deleteElemento-{{$elementoPDF -> id}}" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ url('admin/edicion-pdf/pie/eliminar/'.$elementoPDF -> id) }}" method = "post">
                        @csrf
                        {{ method_field ('DELETE') }}
                        <div class="modal-header">						
    ...
    <div id="add" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
            <form action="{{ route('admin/edicion-pdf/pie.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    <div class="modal-header">						
