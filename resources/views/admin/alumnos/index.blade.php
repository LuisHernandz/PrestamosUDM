            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="" style="width: 50%;">
                            <a href="{{ route('admin/usuarios/alumnos.create') }}" class="btn btn-add" >
                ...
                <div class="containerButtonsIndex"> 
                    <div>
                        <form action="{{ route('admin/usuarios/alumnos.index') }}" class="input-search">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ url('admin/usuarios/alumnos/modificar/'.$usuario -> id) }}" class="edit">
