    ...
    <div id="edit-{{$editorial -> edi_id}}" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ url('admin/libros/editoriales/update') }}" method="post">
                @csrf
                @method('PATCH')
...
@foreach ($editoriales as $editorial)
    <div id="delete-{{$editorial -> edi_id}}" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ url('admin/libros/editoriales/delete/'.$editorial -> edi_id) }}" method = "post">
                    @csrf
                    {{ method_field ('DELETE') }}
                    <div class="modal-header">						
...
<div id="add" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
        <form action="{{ route('/admin/libros/editoriales.store') }}" method="POST">
            @csrf
                <div class="modal-header">						
