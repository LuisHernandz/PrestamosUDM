...
<div class="container-form" style="max-width: 400px">
    <form action="{{ route('/admin/libros/inventario/pdf/filtro.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div style="height: 340px; overflow: auto; padding: 0 15px 0 0;">
           ...
           <div>
            ...
            <div class="form-group">
                ...
                @foreach ($administradores as $usuario)
                    @if (auth()->user()->id == $usuario->usuarios_id)
                        @php
                            $nombreAdministrador = $usuario->adm_nombre . ' ' . $usuario->adm_apellidos; // Guarda el valor en la variable
                        @endphp
                    @endif
                @endforeach
            ...
            <div class="form-group">
                <label>Cargo:</label>
                <input type="text" class="form-control" value="ADMINISTRADOR DEL SISTEMA DE PRESTÁMOS" name="actualizo_cargo" required>
