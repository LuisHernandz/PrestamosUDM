            ...
            <div class="table-wrapper">
                ...
                <div class="containerButtonsIndex">
                    <div style="display: flex;">
                        <form action="{{ route('/admin/libros/autores.index') }}" class="input-search"> 
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                {{ Str::limit($autor -> aut_nombre, 110) }}
                            </td> 
...
<div id="edit-{{$autor -> aut_id}}" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ url('/admin/libros/autores/modificar') }}" method="post">
            @csrf
            @method('PATCH')
...
<div id="delete-{{$autor -> aut_id}}" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ url('/admin/libros/autores/delete/'.$autor -> aut_id) }}" method = "post">
                @csrf
                {{ method_field ('DELETE') }}
                <div class="modal-header">						
...
<div id="add" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
        <form action="{{ route('/admin/libros/autores.store') }}" method="POST">
            @csrf
                <div class="modal-header">						
