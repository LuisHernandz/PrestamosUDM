...
@section('main')
    <div class="container-form">
        <form action="{{ route('/admin/libros/inventario.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="row form-sub">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="file" id ="file-input" class="form-control" value="{{old('lib_foto')}}" name="lib_foto">
