...
@endsection
    ...
    @foreach ($paginas as $pagina )
        <div id="edit-{{$pagina -> id}}" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ url('/admin/portal-de-investigacion/update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                        <div class="modal-header">						
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                <label>Imagen</label>
                                <input type="file" class="form-control" name = "pdi_imagen" id="file-input-update-{{ $pagina -> id }}" accept="image/*" >
    ...
    @foreach ($paginas as $pagina)
        <div id="delete-{{$pagina -> id}}" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ url('/admin/portal-de-investigacion/destroy/'.$pagina -> id) }}" method = "post">
                        @csrf
                        {{ method_field ('DELETE') }}
                        <div class="modal-header">						
    ...
    <div id="add" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
            <form action="{{ url('/admin/portal-de-investigacion/store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    <div class="modal-header">						
