...
@section('main')
    ...
    <div class="chart-container">
        <form action="{{ route('/admin/visitas.index') }}" method="get" style="margin-bottom: 0;">
            ...
            <div style="display: flex; justify-content:center;">
                ...
                <a href="{{ route('/admin/visitas/pdf.index') }}" class="icon-pdf" title="Reporte PDF" style="margin-left: 15px;">
...
<script src="{{url('/assets/js/grafico/chart.js')}}"></script> 
<script src="{{url('/assets/js/grafico/moment.js')}}"></script> 
<script src="{{url('/assets/js/grafico/es.js')}}"></script> 
